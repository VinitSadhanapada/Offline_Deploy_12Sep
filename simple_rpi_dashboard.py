...
"""
    ...
    def run_dashboard(self):
        ...
        try:
            ...
            # Dynamic CSV naming: <PI_NAME>_<LOCATION>_<DATE>.csv with a compatibility symlink 'readings_all.csv'
            self.csv_dir.mkdir(parents=True, exist_ok=True)
            try:
            ...
            try:
                if DEVICE_CONFIG and isinstance(DEVICE_CONFIG, list):
                    location = DEVICE_CONFIG[0].get("location") or "Unknown"
            except Exception:
                pass
            ...
            dynamic_name = f"{pi_name_s}_{location_s}_{date_str}.csv"
